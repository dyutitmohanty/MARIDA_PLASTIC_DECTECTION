...
class_distr = torch.Tensor([0.00452, 0.00203, 0.00254, 0.00168, 0.03226])
...
bands_mean = np.array([0.07155545296812926, 0.07577214664314802, 0.08582589223164594, 0.093932420609203, 
                       ...
                       -0.027345373610526674, 0.4959900482883121, -0.14796084900530523, 0.2350410479371214, 
                       0.15357539733667727, 0.9294167972340819, 0.8016414671369091, 0.588033150263268, 0.686376975379902]).astype('float32')
...
bands_std = np.array([0.07443211031847291, 0.0748053670913034, 0.07364501103370846, 0.08625745277604097, 
                      ...
                      0.026856365587477376, 0.33202821388221554, 0.15275395244193313, 0.6934843086522978, 
                      0.21009568555398592, 0.08309383316744294, 0.2091601919415784, 0.35209269891421563, 0.3041476344800179]).astype('float32')
...
class GenDEBRIS(Dataset): # Extend PyTorch's Dataset class
    ...
    def __getitem__(self, index):
        ...
        stacked_image = np.concatenate((ss,si,glcm), axis=2)

...
from DATA_G2_19 import GenDEBRIS, bands_mean, bands_std, RandomRotationTransform , class_distr, gen_weights
...
if __name__ == "__main__":
    ...
    parser.add_argument('--epochs', default=44, type=int, help='Number of epochs to run')
